...
SceneWidget_AxisIndicator::SceneWidget_AxisIndicator(Scene* scene)
  ...
  MakeCone(x_axis_end, x_axis_end + cone_height * x_axis, cone_radius, segments);
  MakeCone(y_axis_end, y_axis_end + cone_height * y_axis, cone_radius, segments);
  MakeCone(z_axis_end, z_axis_end + cone_height * z_axis, cone_radius, segments);
}
