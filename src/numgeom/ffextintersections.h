...
class FaceFaceIntersections {
 public:
  ...
  struct IntCF {
    ...
    Standard_Real t;  //< Параметр точки пересечения кривой с расширенной
                      //поверхностью грани `F`.
  };
...
Standard_Boolean IsIntersected(const Handle(Geom_BoundedCurve) & curve,
