...
NUMGEOM_EXPORT TriMesh::Ptr MakeSphere(const TriMesh::NodeType& center,
                                       double radius, size_t nSlices,
                                       size_t nStacks);

NUMGEOM_EXPORT TriMesh::Ptr MakeCylinder(const TriMesh::NodeType& s,
                                         const TriMesh::NodeType& t,
                                         double radius, size_t nSlices);

NUMGEOM_EXPORT TriMesh::Ptr MakeCone(const TriMesh::NodeType& s,
