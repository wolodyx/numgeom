...
class Ijk {
 public:
  static Standard_Integer Index(const Ijk& c, Standard_Integer ni,
                                Standard_Integer nj) {
    return c.i + c.j * ni + c.k * ni * nj;
  }

  static Standard_Integer Index(const Ijk& c, const Ijk& n) {
    assert(c.k < n.k);
    return c.i + c.j * n.i + c.k * n.i * n.j;
  }

  static Ijk Coords(Standard_Integer index, Standard_Integer ni,
                    Standard_Integer nj) {
  ...
  static Ijk Coords(Standard_Integer index, const Ijk& n) {
 ...
 public:
  ...
  Ijk(const Standard_Integer* ijk) : i(ijk[0]), j(ijk[1]), k(ijk[2]) {}
  ...
  Ijk operator/(Standard_Integer r) const { return Ijk(i / r, j / r, k / r); }
  ...
  Ijk operator+(const Ijk& o) const { return Ijk(i + o.i, j + o.j, k + o.k); }
